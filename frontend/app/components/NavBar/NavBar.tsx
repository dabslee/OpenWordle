...
const NavBar: React.FC<Props> = ({
  ...
  return (
    <>
      {isMobile ? (
        <div className="flex justify-end pad-sm pad-y-md">
        ...
        <div
          className={"flex justify-center br-lg mrg-t-lg"}
          style={{ width: "100%" }}
        >
          <div
            className="flex justify-center bg-primary br-xl mrg-x-lg border-primary drop-shadow-md"
            style={{ width: "100%" }}
          >
            <div
              className={"row pad-md pad-y-md justify-between"}
              style={{ width: "1032px" }}
            >
              ...
              {!isLoggedIn && (
                <Button variant="primary" {...loginButtonProps} />
              )}
            </div>
          </div>
        </div>
